...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria_id: @produto.categoria_id, codigo: @produto.codigo, descricao: @produto.descricao, marca_id: @produto.marca_id, nome: @produto.nome, preco: @produto.preco, tipopet: @produto.tipopet } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria_id: @produto.categoria_id, codigo: @produto.codigo, descricao: @produto.descricao, marca_id: @produto.marca_id, nome: @produto.nome, preco: @produto.preco, tipopet: @produto.tipopet } }
