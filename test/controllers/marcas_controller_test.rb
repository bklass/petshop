...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { codigo: @marca.codigo, empresa: @marca.empresa, nome: @marca.nome, telefone: @marca.telefone } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { codigo: @marca.codigo, empresa: @marca.empresa, nome: @marca.nome, telefone: @marca.telefone } }
